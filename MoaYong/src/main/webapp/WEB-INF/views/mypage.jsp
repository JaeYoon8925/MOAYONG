														...
														<div class="modal-content">
															...
															<div class="modal-body">
																...
																<div class="btn-group btn-group-sm">
																	<button type="button"
																		class="btn btn-outline-primary">선택</button>
																</div>
																<br> 칭호2 이름
																<div class="btn-group btn-group-sm">
																	<button type="button"
							...
							<section id="first" class="main special">
								...
								<ul class="features">
									<li><span class="icon solid major style1 fa-code"></span>
										...
										<!-- 이 사람이 게시한 프로젝트 리스트 전부 보기 -->
										<!-- 어떻게? 일단 내 id 를 기반으로 
											/ 프로젝트의 참가자테이블에서 프로젝트 순번을 조인 후 select
											select A.prj_name from t_project as A fullouterjoin t_participant as B where 
											/ 상태여부를 판별해서 각각의 리스트에 뿌려줌 -->
										<ul id="UpList" class="UpPjListUp">
											<a href="generic.html" class="button">자세히 봐용</a>
										</ul>
									</li>
									<li><span class="icon major style3 fa-copy"></span>
										...
										<!-- 이 사람의 진행 중 프로젝트 리스트 전부 보기 -->
										<ul id="UpList" class="WIPPjListUp">
											<a href="generic.html" class="button">자세히 봐용</a>
										</ul>
									</li>
									<li><span class="icon major style5 fa-gem"></span>
										...
										<!-- 이 사람의 완료 프로젝트 리스트 전부 보기 -->
										<ul id="UpList" class="ComPjListUp">
											<a href="generic.html" class="button">자세히 봐용</a>
										</ul>
									</li>
								</ul>
